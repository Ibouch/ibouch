...
<img src="./img/robot.png" width="32px"/> • Development of scripts / bots automating the extraction and processing of data from different sources (web, documents etc..).<br/>
